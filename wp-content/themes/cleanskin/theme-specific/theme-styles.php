...
.mptt-navigation-tabs li a, .wp-block-button__link,
...
.wp-block-search:hover .wp-block-search__button:after,
...
.widget_media_video .wp-video .mejs-controls {
	background: {$colors['alter_bg_hover_09']};
}
...
.scheme_self.footer_wrap .widget_calendar td a,
.scheme_self.footer_wrap .wp-calendar-table td a{
	color: {$colors['text_hover']};
}

.scheme_self.footer_wrap .widget_calendar td a:hover,
.scheme_self.footer_wrap .wp-calendar-table td a:hover{
	color: {$colors['text_link']};
}
...
.scheme_self.footer_wrap .wp-calendar-nav .wp-calendar-nav-next a:after{
	background-color: {$colors['alter_bg_color']};
}
...
.sidebar .wp-calendar-nav .wp-calendar-nav-next a:after {
	background-color: {$colors['alter_bg_hover']};
}
...
.sidebar .widget_recent_posts .post_info .post_info_item a:hover {
 	color: {$colors['text_hover']};
}
...
.scheme_self.footer_wrap .select_container select{
