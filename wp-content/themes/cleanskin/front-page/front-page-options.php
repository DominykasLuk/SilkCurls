			...
			'options', 'blog', apply_filters(
				'cleanskin_filter_front_page_options', array(
					...
					'front_page_sections'     => array(
						...
						'desc'       => wp_kses( __( 'Drag and drop sections below to set up their order on the Front Page. You can also enable / disable any section.', 'cleanskin' ), 'cleanskin_kses_content' ),
						'dependency' => array(
		...
		$options                                   = array_merge(
			$options, array(
				...
				'front_page_contacts_content'        => array(
					...
					'refresh' => false,
					'std'     => wp_kses( __( '<h5><span class="icon-home-2"> </span>Find us at the office:</h5><p>500, Lorem Street,<br />Chicago, IL, 55030<br />Mon - Fri, 09:00 - 18:00</p><h5> <span class="icon-mobile-light"> </span>Give us a call:</h5><p>Michael Jordan<br />+40 (123) 456-78-90<br />Mon - Fri, 08:00 - 22:00</p>', 'cleanskin' ), 'cleanskin_kses_content'),
					'type'    => 'text_editor',
				),
